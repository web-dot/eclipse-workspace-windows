package org.o7planning.generator;
...
public class MybatisPlusGenerator {
    ...
    private static final String packageName = "org.o7planning";
    ...
    // 生成的分层代码
    enum LayerType {
        entity("/smvctest01-model"),
        mapper("/smvctest01-dao"),
        mapperxml("/smvctest01-web"),
        service("/smvctest01-service"),
        web("/smvctest01-web"),
        ;
